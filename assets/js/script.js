...
var sec5=document.getElementById("sec5heading");
var glass=document.querySelector('.worksbox');
var cardbg=document.querySelectorAll('.card');
var cardtext=document.querySelectorAll('.card-body');
var sec6=document.getElementById("sec6heading");


var c1=document.getElementById('c1');
var c2=document.getElementById('c2');
var c3=document.getElementById('c3');
var print=document.getElementById("downloadbtn");
...
function darkmoder() {
    ...
    glass.style.background="rgba( 98, 98, 98, 0.65 )";
    for(var i=0;i<cardbg.length;i++){
        cardbg[i].style.background="#7f8285";
        cardtext[i].style.color="white";
    }
    sec6.style.color="white";
...
function lightmoder() {
    ...
    bgsrc.src="/assets/images/bg.jpg";
    subsrc.src="/assets/images/subject.png";
    sec5.style.color="black";
    glass.style.background="rgba( 150, 150, 150, 0.75 )";
    for(var i=0;i<cardbg.length;i++){
        cardbg[i].style.background="rgb(88, 88, 88)";
        cardtext[i].style.color="white";
    }
    sec6.style.color="black";
...
function prmoder() {
    ...
    sec5.style.color="rgba(245, 245, 245, 0.596)"; 
    glass.style.background="rgba( 139, 8, 236, 0.45 )";
    for(var i=0;i<cardbg.length;i++){
        cardbg[i].style.background="white";
        cardtext[i].style.color="black";
    }
    sec6.style.color="rgba(245, 245, 245, 0.596)";
}
...
function sendEmail() {
  var recipient = 'raghulkalai92@gmail.com'; // Replace with the recipient's email address
  var subject = 'Hello'; // Replace with the email subject
